...
import rje, rje_aaprop, rje_blast, rje_disorder, rje_motif_stats, rje_scoring, rje_seq, rje_sequence
    ...
    def proteinAlignments(self,alndir='',hitname='AccNum'):    ### Generates copies of protein alignments, with motif hits marked.
        ...
        try:
            ...
            for seq in motif_occ.keys():
                ...
                self.singleProteinAlignment(seq,occlist,alndir,hitname,gopher=True)                
        except:            
            self.log.errorLog('Major problem with SlimPicker.proteinAlignments',quitchoice=True)
#########################################################################################################################
    def singleProteinAlignment(self,seq,occlist,alndir='',hitname='AccNum',gopher=True,savefasta=True):    ### Generates copies of protein alignments, with motif hits marked.
        '''
        ...
        try:
            ...
            _stage = 'Alignment'
            if self.opt['UseAln']: aln = rje_motif_stats.loadOrthAln(self,seq,gopher=gopher)
